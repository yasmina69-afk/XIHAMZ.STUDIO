...
let songs = [
    ...
    },
    {
        ...
        album: "Prism",
        albumArtUrl: "https://image.idntimes.com/post/20250522/1-09cfee9393ddb887a892c77209de32ef.jpg?tr=w-1920",
        audioSrc: "audio/Naykilla, Tenxi & Jemsii - Kasih Aba-Aba (Official Music Video).mp3",
        videoBgSrc: "videos/KASIH ABA ABA.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics:[
            { time: 3.2, text: "Oh wow" },
            { time: 4.5, text: "ooii jemsi" },
            { time: 10, text: "Ku mersakan apa yang kurasakan" },
            { time: 14.8, text: "Tanpa ragu ku bilang kamu yang paling paham aku" },
            { time: 19.5, text: "Dua jadi satu belah hati aku," },
            { time: 23.3, text: "Aku mau maju tapi tinggal tunngu waktu" },
            { time: 28, text: "Kasi aba-aba kalo udah siap" },
            { time: 32.4, text: "Kucoba melihat tapi masih gelap" },
            { time: 36.5, text: "Kamu paling bright" },
            { time: 38.5, text: "Gapapa le- gapapa lebay"  },
            { time: 42.9, text: "Yeah, aku mau test" },
            { time: 44.3, text: "Dia mau aku atau mau cash but she know" },
            { time: 46.9, text: " That im the best udah pintar ku gausah les" },
            { time: 50.3, text: "Dia suka baju hitamku celana camo ku" },
            { time: 53.5, text: "Kalo kurang asik kita putar lagu" },
            { time: 55.6, text: "Lagu siapa? Ya lagu aku" },
            { time: 57.8, text: "Kalo duet ya sama kamu" },
            { time: 60.3, text: "Ku merasakan apa yang kau rasakan" },
            { time: 64.6, text: "Tanpa ragu kubilang kamu yang paling paham aku" },
            { time: 69.3, text: "Dua jadi satu belah hati aku" },
            { time: 73.5, text: "Aku mau maju tapi tinggal tunngu waktu" },
            { time: 76.8, text: "Ku merasakan apa yang kau rasakn" },
            { time: 81.5, text: "Tanpa ragu kubilang kamu yang paling paham aku" },
            { time: 86.4, text: "Dua jadi satu belah hati aku" },
            { time: 90.5, text: "Aku mau maju tapi tinggal tunngu waktu" },
            { time: 94.1, text: "Dia tanya aku punya plan (hey)" },
            { time: 96, text: "Dia tau kalo im the man (yeah, yeah)" },
            { time: 97.8, text: "Kamu tinkerbell aku peterpan" },
            { time: 99.5, text: "tapi ini nyata no bukan cerpen" },
            { time: 101.8, text: "Ini bukan cerpen, she's 10 out of 10" },
            { time: 104, text: "Pilih mau mana, dollar atau yen?" },
            { time: 106, text: "Angkat koper, kita pergi Japan" },
            { time: 108, text: "I'll give you the best that I can" },
            { time: 109.8, text: "Aku mau cari jalan tengah" },
            { time: 112.1, text: "Buat kamu, apa yang nggak bisa?" },
            { time: 114.5, text: "Ajak kamu ke angkasa" },
            { time: 116.4, text: "Go to the moon, kita berdansa" },
            { time: 118.3, text: "Aku wish you best (uuu)" },
            { time: 120.2, text: "Kamu yang the best (uuu)" },
            { time: 122.2, text: "Kata mamaku" },
            { time: 124.7, text: "Masih muda, banyak waktu" },
            { time: 127.8, text: "Ku merasakan apa yang kaurasakan" },
            { time: 131.9, text: "Tanpa ragu, kubilang kamu yang paling paham aku" },
            { time: 136.7, text: "Dua jadi satu, belah hati aku" },
            { time: 140.7, text: "Aku mau maju, tapi tinggal tunggu waktu" },
            { time: 143.8, text: "🎵🎵🎵🎵🎵🎵🎵🎵🎵🎵🎵" },
